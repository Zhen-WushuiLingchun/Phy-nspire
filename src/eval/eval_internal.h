...
typedef enum {
    ...
    EVAL_HEAD_CHARACTERISTIC_POLYNOMIAL,
    EVAL_HEAD_EIGENVALUES,
    EVAL_HEAD_EIGENVECTORS,
    EVAL_HEAD_EIGENSPACE,
    EVAL_HEAD_GENERALIZED_EIGENSPACE,
    EVAL_HEAD_JORDAN_DECOMPOSITION,
    EVAL_HEAD_INVERSE,
