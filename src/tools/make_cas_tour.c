...
static const tour_cell kTour[] = {
    ...
    {TOUR_INPUT, "Simplify[Root[{-2,0,1},2]^2]", NULL},
    {TOUR_INPUT, "Simplify[1/Root[{-2,0,1},2]]", NULL},
    {TOUR_INPUT,
    ...
    {TOUR_INPUT, "Eigenvectors[Matrix[{{0,-1},{1,0}}]]", NULL},
    {TOUR_INPUT, "jm=Matrix[{{2,1},{0,2}}]", NULL},
    {TOUR_INPUT, "Eigenspace[jm,2]", NULL},
    {TOUR_INPUT, "GeneralizedEigenspace[jm,2]", NULL},
    {TOUR_INPUT, "JordanDecomposition[jm]", NULL},
