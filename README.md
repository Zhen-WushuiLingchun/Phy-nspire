...
notebook combines thirteen Markdown/LaTeX explanations with 121 executable examples
that touch every implemented evaluator head. Its distributable form contains 134
