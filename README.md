...
passes 32/32, and the assertion-bearing executables contain 95,595 explicit
checks.

The current native build is measured at 1,124,477 bytes, 17.9% of the 6 MiB
...
replacement and the current 1,124,477-byte program have not been uploaded in
